...
class TermObject():
    ...
    def fetch(self):
        if not self.__fetched: self.__fetch_all()
        self.__fetched = True
        return {
            'term': self.__term,
    ...
    def __fetch_student_optimization_rules(self):
        ...
        sql_where = f"term_id = {self.__term_id}"
        cur.execute(' '.join(['select', sql_select , 'from', sql_from , 'where', sql_where]))
        self.__student_optimization_rules = list(map(lambda record: dict(record), cur.fetchall()))
        cur.close()
    ...
    def __fetch_term_teachers(self):
        ...
        cur.execute(' '.join(['select', sql_select , 'from', sql_from , 'where', sql_where]))
        self.__term_teachers = list(map(lambda record: dict(record), cur.fetchall()))
        cur.close()
    ...
    def __fetch_term_students(self):
        ...
        cur.execute(' '.join(['select', sql_select, 'from', sql_from, 'where', sql_where]))
        self.__term_students = list(map(lambda record: dict(record), cur.fetchall()))
        cur.close()
    ...
    def __fetch_term_tutorials(self):
        ...
        cur.execute(' '.join(['select', sql_select, 'from', sql_from, 'where', sql_where]))
        self.__term_tutorials = list(map(lambda record: dict(record), cur.fetchall()))
        cur.close()
    ...
    def __fetch_term_groups(self):
        ...
        cur.execute(' '.join(['select', sql_select, 'from', sql_from, 'where', sql_where]))
        self.__term_groups = list(map(lambda record: dict(record), cur.fetchall()))
        cur.close()
    ...
    def __fetch_student_vacancies(self):
        ...
        cur.execute(' '.join(['select', sql_select, 'from', sql_from, 'where', sql_where]))
        self.__student_vacancies = list(map(lambda record: dict(record), cur.fetchall()))
        cur.close()
    ...
    def __fetch_teacher_vacancies(self):
        ...
        sql_where = f"timetables.term_id = {self.__term_id}"
        cur.execute(' '.join(['select', sql_select, 'from', sql_from, 'where', sql_where]))
        self.__teacher_vacancies = list(map(lambda record: dict(record), cur.fetchall()))
        cur.close()
    ...
    def __fetch_tutorial_pieces(self):
        ...
        cur.execute(' '.join(['select', sql_select, 'from', sql_from, 'where', sql_where]))
        self.__tutorial_pieces = list(map(lambda record: dict(record), cur.fetchall()))
        cur.close()
    ...
    def __fetch_tutorial_contracts(self):
        ...
        sql_where = f"term_id = {self.__term_id}"
        cur.execute(' '.join(['select', sql_select, 'from', sql_from, 'where', sql_where]))
        self.__tutorial_contracts = list(map(lambda record: dict(record), cur.fetchall()))
        cur.close()
    ...
    def __fetch_teacher_group_timetables(self):
        ...
        sql_where = f"timetables.term_id = {self.__term_id}"
        cur.execute(' '.join(['select', sql_select, 'from', sql_from, 'where', sql_where]))
        self.__teacher_group_timetables = list(map(lambda record: dict(record), cur.fetchall()))
        cur.close()
    ...
    def __fetch_student_group_timetables(self):
        ...
        sql_where = f"group_contracts.term_id = {self.__term_id} and group_contracts.is_contracted = true"
        cur.execute(' '.join(['select', sql_select, 'from', sql_from, 'where', sql_where]))
        self.__student_group_timetables = list(map(lambda record: dict(record), cur.fetchall()))
        cur.close()
