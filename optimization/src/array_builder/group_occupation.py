...
class GroupOccupation():
    ...
    def __build_student_occupation(self):
        self.__student_occupation_array = numpy.zeros(
        ...
        for student_index, date_index, period_index in product:
            ...
            if is_exist: self.__student_occupation_array[student_index, date_index, period_index] = 1

    def __build_teacher_occupation(self):
        self.__teacher_occupation_array = numpy.zeros(
        ...
        for teacher_index, date_index, period_index in product:
            ...
            if is_exist: self.__teacher_occupation_array[teacher_index, date_index, period_index] = 1

    def student_occupation_array(self):
        return self.__student_occupation_array

    def teacher_occupation_array(self):
        return self.__teacher_occupation_array
