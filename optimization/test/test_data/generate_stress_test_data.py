...
def generate_stress_test_data():
    ...
    term_teachers_json = open('./test/test_data/stress/term_teachers.json', 'r')
    term_students_json = open('./test/test_data/stress/term_students.json', 'r')
    term_tutorials_json = open('./test/test_data/stress/term_tutorials.json', 'r')
    term_groups_json = open('./test/test_data/stress/term_groups.json', 'r')
    teacher_vacancies_json = open('./test/test_data/stress/teacher_vacancies.json', 'r')
    student_vacancies_json = open('./test/test_data/stress/student_vacancies.json', 'r')
    tutorial_contracts_json = open('./test/test_data/stress/tutorial_contracts.json', 'r')
    tutorial_pieces_json = open('./test/test_data/stress/tutorial_pieces.json', 'r')
    ...
    begin_at_datetime = datetime.datetime.strptime(term['begin_at'], '%Y-%m-%d')
    begin_at_date = datetime.date(begin_at_datetime.year, begin_at_datetime.month, begin_at_datetime.day)
    end_at_datetime = datetime.datetime.strptime(term['end_at'], '%Y-%m-%d')
    end_at_date = datetime.date(end_at_datetime.year, end_at_datetime.month, end_at_datetime.day)
