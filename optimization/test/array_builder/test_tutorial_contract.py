...
class TestTutorialContract(TestCase):
    def test_normal_term(self):
        ...
        self.assertEqual(numpy.sum(tutorial_contract.tutorial_contract_array()), 60)

    def test_season_term(self):
        array_size = ArraySize(season_term)
        tutorial_contract = TutorialContract(season_term, array_size)
        self.assertEqual(numpy.sum(tutorial_contract.tutorial_contract_array()), 240)
    ...
    def test_exam_planning_term(self):
        ...
        self.assertEqual(numpy.sum(tutorial_contract.tutorial_contract_array()), 20)
