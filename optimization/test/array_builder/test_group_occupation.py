...
class TestGroupOccupation(TestCase):
    def test_normal_term(self):
        ...
        self.assertEqual(
            numpy.sum(group_occupation.teacher_occupation_array()), 2)
        self.assertEqual(
            numpy.sum(group_occupation.student_occupation_array()), 40)
    ...
    def test_season_term(self):
        ...
        group_occupation = GroupOccupation(term, array_size)
        self.assertEqual(
            numpy.sum(group_occupation.teacher_occupation_array()), 8)
        self.assertEqual(
            numpy.sum(group_occupation.student_occupation_array()), 160)
    ...
    def test_exam_planning_term(self):
        ...
        self.assertEqual(
            numpy.sum(group_occupation.teacher_occupation_array()), 2)
        self.assertEqual(
            numpy.sum(group_occupation.student_occupation_array()), 20)
