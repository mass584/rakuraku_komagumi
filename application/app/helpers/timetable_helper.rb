module TimetableHelper
  def begin_at_cell(begin_end_times, period_index)
    ...
    content_tag(:td, class: 'align-middle bg-light') do
      content_tag(:div, 'data-id' => begin_end_time.id, 'data-begin_at' => time,
                        'class' => 'min-width-150') do
        time_field_tag(:begin_at, time, id: "begin_at_#{period_index}",
  ...
  def end_at_cell(begin_end_times, period_index)
    ...
    content_tag(:td, class: 'align-middle bg-light') do
      content_tag(:div, 'data-id' => begin_end_time.id, 'data-end_at' => time,
                        'class' => 'min-width-150') do
        time_field_tag(:end_at, time, id: "end_at_#{period_index}",
                                      class: 'form-control form-control-sm')
      end
    end
  end
