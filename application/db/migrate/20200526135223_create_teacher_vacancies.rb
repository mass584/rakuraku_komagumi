class CreateTeacherVacancies < ActiveRecord::Migration[5.2]
  def change
    create_table :teacher_vacancies do |t|
      t.integer :term_teacher_id, null: false
      t.integer :timetable_id, null: false
      t.boolean :is_vacant, default: false, null: false
      t.timestamps
    end
    add_index :teacher_vacancies, [:term_teacher_id, :timetable_id], unique: true
